...
function TIB.new(variant,theme)
  ...
  local new = Btn.new()
  local label = gnui.newLabel():setAnchor(0,0,1,1):setAlign(0,0.5):setBlockMouse(false)
  new.Label = label
  new.ConfirmedText = ""
  new.PotentialText = ""
  new.BarCaret = gnui.newLabel():setText(""):setAnchor(0,0,1,1):setAlign(0,0.5):setBlockMouse(false)
  new.PlaceholderText = ""
  new.editing = false
