...
local defaultColors = {
   (vectors.hexToRGB("#99e65f") * 255):floor()/255,
   (vectors.hexToRGB("#d3fc7e ") * 255):floor()/255,
   (vectors.hexToRGB("#99e65f") * 255):floor()/255,
   (vectors.hexToRGB("#1e6f50") * 255):floor()/255,
 }
      ...
      function(entity)
         if player:isLoaded() then
            ...
            for i = 1, 10, 1 do
               ...
               :color(defaultColors[math.random(1,#defaultColors)]):spawn()
            end
         end
      end
   },
