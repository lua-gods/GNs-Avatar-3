...
local function newGame()
   ...
   p1ScoreLabel:setText(tostring(p1Score)):setAnchor(0,0,1,1):setAlign(0.25,0.1):setTextEffect("OUTLINE"):setCanCaptureCursor(false):setFontScale(2)
   local p2ScoreLabel = GNUI.newLabel()
   p2ScoreLabel:setText(tostring(p2Score)):setAnchor(0,0,1,1):setAlign(0.75,0.1):setTextEffect("OUTLINE"):setCanCaptureCursor(false):setFontScale(2)
